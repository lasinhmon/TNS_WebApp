...
namespace TNS_KPI.Areas.KPI_Accounting.Pages
{
    ...
    public class HauKiemBT_NoneModel : PageModel
    {
        ...
        public IActionResult OnPostLoadData([FromBody] ItemRequest request)
        {
            ...
            string zSQL_Count = "SELECT Count(*) FROM [dbo].[KPI_Accounting_HauKiemBT_None] " + zWhere;
            ...
            string zSQL = "SELECT " + zListField + " FROM [dbo].[KPI_Accounting_HauKiemBT_None] " + zWhere + " ORDER BY col_buscd ";
        ...
        public IActionResult OnPostLoadDataGroupBy([FromBody] ItemRequest request)
        {
            ...
            string zSQL = "SELECT " + zListField + " FROM [dbo].[KPI_Accounting_HauKiemBT_None] " + zWhere
                + " GROUP BY " + zGroupBy
                + " ORDER BY " + zOrderBy;
        ...
        public IActionResult OnPostSearchEmployee([FromBody] ItemRequest request)
        {
            ...
            List<string[]> zListEmployee = Models.AccessData.HauKiemBT_None_GetEmployee(zMonth, zYear);
        ...
        {
            CheckAuth();
            List<string[]> zData = Models.AnalyticsData.ReportQuick_NoneHauKiemBT(int.Parse(request.MonthView), int.Parse(request.YearView));
        ...
        public IActionResult OnPostAnalyticsByModule([FromBody] ItemRequest request)
        {
            ...
            ItemView zItem = new ItemView();
            List<string[]> zData = Models.AnalyticsData.ReportQuick_NoneHauKiemBT_ByModule(int.Parse(request.MonthView), int.Parse(request.YearView));
            return new JsonResult(zData);
        }
