...
namespace TNS_KPI.Areas.KPI_Service.Models
{
    public class EMobile_Model
    {
        ...
        public string Rmk { get => _Rmk; set => _Rmk = value; }
        public string Message { get => _Message; set => _Message = value; }

        #endregion
        #region [ Constructor Get Information ]
        public EMobile_Model()
        {
           
        }
        public EMobile_Model(string tam)
        {
        ...
        public string Save()
        {
            string zSQL = "INSERT into [dbo].[KPI_Service_IssueEMobile] Values (newid(),MONTH(GETDATE()), YEAR(GETDATE()),@rmk,'Active',CONVERT(DATE, GETDATE(), 120),@crtusr,@pgd)";
            string zResult = "";
            ...
            try
            {
                ...
                zCommand.Parameters.Add("@rmk", SqlDbType.NVarChar).Value = Rmk;
