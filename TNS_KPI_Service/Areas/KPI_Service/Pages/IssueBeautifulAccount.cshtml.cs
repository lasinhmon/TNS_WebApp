...
namespace TNS_KPI.Areas.KPI_Service.Pages
{
    ...
    public class IssueBeautifulAccountModel : PageModel
    {
        #region [ Security ]
        ...
        public IActionResult OnPostLoadData([FromBody] ItemRequest request)
        {
            ...
            string zListField = "UserName,Remark ";
            ...
            string zSQL = "SELECT " + zListField + " FROM [dbo].[KPI_Service_IssueBeautifulAccount] " + zWhere + " ORDER BY UserName ";
            string zSQL_Count = "SELECT Count(*) FROM [dbo].[KPI_Service_IssueBeautifulAccount] " + zWhere;
