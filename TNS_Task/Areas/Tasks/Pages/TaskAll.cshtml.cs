...
{
    public class TaskAllModel : PageModel
    {
        private string _PageViewCookiedName = "Task_TaskAll";
        ...
        public Task_List _TaskList = new Models.Task_List("TaskKey,Subject,CreatedOn,FinishDate,StatusName,Complete,PriorityKey,StatusKey");
        public IActionResult OnGet()
        {

            #region [ Check Security ]
            CheckAuth();
           /* if (!RoleActionOnPage.IsRead)
            {
           ...
           */
            ...
            this.TaskListView = _TaskList.Owner_List(200, UserLogin.Employee.Key);
          ...
          */
            ...
            switch(action)
            {
                case "cmdSearch":
                    if (pageSearch != null)
                    {
                        this.TaskListView = _TaskList.Owner_List_Smart(200, pageSearch, UserLogin.Employee.Key);
